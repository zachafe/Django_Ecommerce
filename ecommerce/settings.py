...
SECRET_KEY = 'django-insecure-&pqo%dtzoguqwd(3wn*i&^30&hq(_$28%l4)+2zg5kl$%sgv!='
...
TEMPLATES = [
    {
        ...
        #LLAMAR LA CARPETA TEMPLATES CREADA EN LA BASE
...
EMAIL_HOST_PASSWORD = 'Emcali@ndr3s'